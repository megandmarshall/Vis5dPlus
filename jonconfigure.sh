...
export F77=gfortran
./configure --enable-threads --prefix=/home/jon/
make distclean
./configure --enable-threads --prefix=/home/jon/
make
make install
...
make
make install
chown -R jmckinne /home/jon/vis5dalt/lib/
chgrp -R jmckinne /home/jon/vis5dalt/lib/
chown -R jmckinne /home/jon/vis5dalt/bin/
chgrp -R jmckinne /home/jon/vis5dalt/bin/

# if modifying glade/gtk stuff (interactive during make):
# ./configure --enable-threads --prefix=/home/jon/ --enable-maintainer-mode     
